 ...
 * No rounded corners, no gradients, thick borders, offset shadows, Outfit 900-weight.
 */
...
function introTemplate(slide: YTSlide): string {
  ...
  <div style="position:absolute;top:0;left:0;width:560px;height:1080px;display:flex;flex-direction:column;justify-content:center;padding:60px">
    <div style="font-family:'JetBrains Mono',monospace;font-size:14px;font-weight:700;color:${SAGE};letter-spacing:6px;margin-bottom:20px">ANDY NORMAN</div>
    <div style="font-family:'JetBrains Mono',monospace;font-size:14px;font-weight:700;color:${CREAM};opacity:0.7;letter-spacing:3px">ANTEK AUTOMATION</div>
    <div style="width:80px;height:4px;background:${CORAL};margin:32px 0"></div>
    <div style="font-family:'JetBrains Mono',monospace;font-size:13px;font-weight:700;color:${CREAM};letter-spacing:4px;opacity:0.6">QUICK TIPS</div>
  </div>
  ...
  <div style="position:absolute;top:0;left:580px;right:0;bottom:120px;display:flex;align-items:center;padding:60px">
    <div style="font-family:'Outfit',sans-serif;font-size:100px;font-weight:900;color:${CREAM};line-height:1.05;letter-spacing:-3px">${esc(slide.text)}</div>
  </div>
  <!-- CREAM bottom strip -->
  <div style="position:absolute;bottom:0;left:0;right:0;height:80px;background:${CREAM};display:flex;align-items:center;padding:0 60px;justify-content:space-between">
    <div style="font-family:'JetBrains Mono',monospace;font-size:20px;font-weight:700;color:${CHARCOAL}">antekautomation.com</div>
    <div style="font-family:'JetBrains Mono',monospace;font-size:20px;font-weight:700;color:${CHARCOAL};opacity:0.6">0333 038 9960</div>
  </div>
</div>`;
}
...
function contextTemplate(slide: YTSlide): string {
  ...
  <div style="position:absolute;top:0;left:0;right:0;height:100px;background:${CORAL};display:flex;align-items:center;padding:0 80px">
    <div style="font-family:'JetBrains Mono',monospace;font-size:28px;font-weight:700;color:${CREAM};letter-spacing:8px">THE SITUATION</div>
  </div>
  ...
  <div style="position:absolute;top:160px;left:80px;right:120px;bottom:140px;display:flex;align-items:center">
    <div style="font-family:'Outfit',sans-serif;font-size:76px;font-weight:900;color:${CREAM};line-height:1.15;letter-spacing:-2px">${esc(slide.text)}</div>
  </div>
  ...
  <div style="position:absolute;bottom:0;left:0;right:0;height:80px;background:${CORAL};display:flex;align-items:center;padding:0 80px">
    <div style="font-family:'JetBrains Mono',monospace;font-size:20px;font-weight:700;color:${CREAM}">@AntekAutomation</div>
  </div>
</div>`;
}
...
function pointTemplate(slide: YTSlide): string {
  ...
  <div style="position:absolute;top:-40px;left:-40px;font-family:'Outfit',sans-serif;font-size:600px;font-weight:900;color:${CHARCOAL};opacity:0.08;line-height:1">${num}</div>
  ...
  <div style="position:absolute;top:0;left:0;width:400px;height:1080px;display:flex;flex-direction:column;justify-content:center;align-items:center;gap:16px">
    <div style="font-family:'Outfit',sans-serif;font-size:160px;font-weight:900;color:${CREAM};line-height:1">${num}</div>
    <div style="background:${CHARCOAL};padding:10px 24px">
      <div style="font-family:'JetBrains Mono',monospace;font-size:18px;font-weight:700;color:${CREAM};letter-spacing:6px">POINT ${num}</div>
    </div>
  </div>
  <!-- Right content -->
  <div style="position:absolute;top:0;left:440px;right:60px;bottom:100px;display:flex;align-items:center">
    <div style="font-family:'Outfit',sans-serif;font-size:80px;font-weight:900;color:${CHARCOAL};line-height:1.15;letter-spacing:-2px">${esc(slide.text)}</div>
  </div>
  <!-- CORAL rule line -->
  ...
  <div style="position:absolute;bottom:0;left:0;right:0;height:80px;background:${CHARCOAL};display:flex;align-items:center;padding:0 80px;justify-content:space-between">
    <div style="font-family:'JetBrains Mono',monospace;font-size:18px;font-weight:700;color:${CREAM}">@AntekAutomation</div>
    <div style="font-family:'JetBrains Mono',monospace;font-size:18px;font-weight:700;color:${SAGE}">antekautomation.com</div>
  </div>
</div>`;
}
...
function takeawayTemplate(slide: YTSlide): string {
  ...
  <div style="position:absolute;top:0;left:0;width:480px;height:1080px;background:${CORAL};display:flex;flex-direction:column;justify-content:center;padding:60px">
    <div style="font-family:'Outfit',sans-serif;font-size:72px;font-weight:900;color:${CREAM};line-height:1;letter-spacing:-2px">THE<br>TAKE<br>AWAY</div>
  ...
  <div style="position:absolute;top:0;left:520px;right:60px;bottom:80px;display:flex;align-items:center">
    <div style="font-family:'Outfit',sans-serif;font-size:84px;font-weight:900;color:${CREAM};line-height:1.1;letter-spacing:-2px">${esc(slide.text)}</div>
  </div>
  ...
  <!-- Bottom strip -->
  <div style="position:absolute;bottom:0;left:0;right:0;height:80px;background:${CORAL};display:flex;align-items:center;padding:0 80px">
    <div style="font-family:'JetBrains Mono',monospace;font-size:20px;font-weight:700;color:${CREAM}">Andy Norman · Antek Automation</div>
  </div>
</div>`;
}
...
function ctaTemplate(): string {
  ...
  <div style="position:absolute;top:0;left:0;width:1120px;height:1080px;display:flex;flex-direction:column;justify-content:center;padding:80px">
    <div style="font-family:'JetBrains Mono',monospace;font-size:28px;font-weight:700;color:${CORAL};letter-spacing:4px;margin-bottom:24px">FOLLOW US</div>
    <div style="font-family:'Outfit',sans-serif;font-size:120px;font-weight:900;color:${CREAM};line-height:1;letter-spacing:-4px">@Antek<br>Automation</div>
    <div style="margin-top:40px;display:flex;flex-direction:column;gap:12px">
      <div style="font-family:'JetBrains Mono',monospace;font-size:36px;font-weight:700;color:${CREAM}">antekautomation.com</div>
      <div style="font-family:'JetBrains Mono',monospace;font-size:30px;font-weight:700;color:${CREAM};opacity:0.75">0333 038 9960</div>
    </div>
  </div>
  <!-- Right panel content -->
  <div style="position:absolute;top:0;right:0;width:800px;height:700px;display:flex;flex-direction:column;justify-content:center;padding:60px;z-index:2">
    <div style="font-family:'DM Sans',sans-serif;font-size:52px;font-weight:900;color:${CREAM};line-height:1.1">Subscribe for AI tips built for UK small business</div>
  ...
  <div style="position:absolute;bottom:0;left:0;right:0;height:80px;background:${CREAM};display:flex;align-items:center;padding:0 80px">
    <div style="font-family:'JetBrains Mono',monospace;font-size:20px;font-weight:700;color:${CHARCOAL}">AI Automation for UK Service Businesses · Andover, Hampshire</div>
  </div>
</div>`;
}
